...
const redisClient = createClient({
    socket: {
        host: process.env.REDIS_HOST || 'relaxing-flea-30894.upstash.io',
        port: process.env.REDIS_PORT || 6379,
    },
    password: process.env.REDIS_PASSWORD || AXiuAAIncDFlOThmNWMzMTFhMjY0N2YwYmEyN2NkOGU1MWVmYmRmYnAxMzA4OTQ,
});
